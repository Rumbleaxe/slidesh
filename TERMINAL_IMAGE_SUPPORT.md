...
### 3. **Sixel** (Legacy but widely supported)
...
- **Kitty/iTerm2/Sixel**: Image displays directly in terminal
- **Other terminals**: Image is silently skipped (no errors)

## Background Colors in CLI

All themes now support background colors in the CLI:

```bash
# Dracula theme with dark purple background
